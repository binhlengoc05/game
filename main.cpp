...
int main(int argc, char* argv[])
{
    ...
    SDL_Texture* background = loadTexture("background 2.jpg", renderer);
    ...
    SDL_Texture* player= loadTexture("man run2.png", renderer);
    ...
    SDL_RenderCopy(renderer,player,&playerSrc,&playerRect);
